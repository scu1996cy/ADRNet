...
from OurTransformer import AEMorph
...
def main():
    batch_size = 1
    train_dir = '/home/cy/OASIS/OASIS_L2R_2021_task03/All/'
    val_dir = '/home/cy/OASIS/OASIS_L2R_2021_task03/Val_10/'
    weights = [1, 5] # loss weights
    save_dir = 'AEMorph_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    for epoch in range(epoch_start, max_epoch):
        ...
        }, save_dir='experiments/'+save_dir, filename='dsc{:.4f}epoch{:.4f}.pth.tar'.format(eval_dsc.avg, epoch))
